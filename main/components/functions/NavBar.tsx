                    ...
                    <div className="flex items-center gap-4">
                        <nav className="hidden lg:block mr-4">
                            <div className="flex gap-6">
                                ...
                                <NavLink href="/project" icon={<GrResources className="h-5 w-5" />} text="Resources" />
                                <NavLink href="/categories" icon={<FaCompressArrowsAlt className="h-5 w-5" />} text="Conflicts" />
                            </div>
                        </nav>
                        <ModeToggle />
